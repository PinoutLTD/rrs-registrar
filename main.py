...
def main() -> None:
    ...
    get_file_from_IPFS_callback = operator.get_file_from_IPFS_callback()
    registar = Registar(add_user_callback, unpin_logs_from_IPFS_callback, get_file_from_IPFS_callback)
